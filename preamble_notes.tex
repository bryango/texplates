...
%	\setlength{\skip\footins}{.8\baselineskip} % pre footnote split, plain TeX
	\setlength{\footnotesep}{.8\baselineskip}      % post footnote parskip
	\usepackage[bottom,splitrule,hang]{footmisc}
...
% Header
	...
	\fancypagestyle{headless}{
		\fancyhead{}
		\setlength{\headsep}{-.8\baselineskip}
	}
